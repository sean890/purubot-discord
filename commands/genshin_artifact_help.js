...
module.exports = {
    name: 'genshin_artifact_help',
    description: "help manual for using ~g artifact commands",
    execute(Discord, message) {

        // fetch help message string from file
        fs.readFile(path.resolve(__dirname, "genshin-data", "genshin_artifact_help.txt"), 'utf8', function(err, data) {
