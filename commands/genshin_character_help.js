...
module.exports = {
    name: 'genshin_character_help',
    description: "help manual for using ~g character commands",
    execute(Discord, message) {

        // fetch help message string from file
        fs.readFile(path.resolve(__dirname, "genshin-data", "genshin_character_help.txt"), 'utf8', function(err, data) {
